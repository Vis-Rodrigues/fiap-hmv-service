...
@Entity
@Table(name="tb_perguntas_emergencia")
@Data
@AllArgsConstructor
@NoArgsConstructor
public class PerguntaQuestionarioEmergencia implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 98224927720042281L;
